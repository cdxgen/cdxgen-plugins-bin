...
wget https://github.com/osquery/osquery/releases/download/5.22.1/osquery-5.22.1_1.linux_x86_64.tar.gz
tar -xf osquery-5.22.1_1.linux_x86_64.tar.gz
...
rm osquery-5.22.1_1.linux_x86_64.tar.gz
