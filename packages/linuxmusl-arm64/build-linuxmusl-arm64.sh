...
for attempt in 1 2 3 4 5 6; do
  oras pull ghcr.io/cdxgen/cdxgen-plugins-bin:kosi-linuxmusl-arm64 -o plugins/kosi/ && break
  echo "kosi cache tag kosi-linuxmusl-arm64 not ready (attempt $attempt)"; sleep 60
done
oras pull ghcr.io/cdxgen/cdxgen-plugins-bin:kosi-linuxmusl-arm64 -o plugins/kosi/
