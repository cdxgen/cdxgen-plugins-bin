...
pull_artifacts() {
  ...
  # P28: the scratch build lives in scripts/scratch-resolve/ and is shared
  # with scripts/acquire-classpath.sh -- one resolver, two callers.
  cp "$repo_root/scripts/scratch-resolve/build.gradle.kts" "$scratch/build.gradle.kts"
