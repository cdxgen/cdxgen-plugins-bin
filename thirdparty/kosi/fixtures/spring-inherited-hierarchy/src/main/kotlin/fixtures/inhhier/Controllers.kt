...
@RestController @RequestMapping("/p9") class C9 : fixtures.inhhier.base.Base9()
@RestController @RequestMapping("/p10") class C10 : fixtures.inhhier.base.Same()
