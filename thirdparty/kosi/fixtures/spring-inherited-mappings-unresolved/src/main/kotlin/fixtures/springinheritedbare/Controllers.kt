// spring-inherited-mappings with NO spring-web or JAX-RS on the classpath:
// every mapping resolves through its import. Same wants, same negatives.
...
package fixtures.springinheritedbare
