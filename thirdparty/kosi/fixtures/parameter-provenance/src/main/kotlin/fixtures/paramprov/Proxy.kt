// P21 §0: the depth report's PARAMETER bucket had never been non-zero —
...
// The zero was the R131 shape waiting: a bucket nobody drives is a bucket
// nobody measures.
//
...
// R131's defect made the whole fold fall back to.
//
