...
/**
 * P28 review: `ALL_PAYLOAD_SIMPLE_TYPES` is a hand-written twin of a fact the
 * pack already carries — the `simpleParameterTypes` rows P27 §2 transcribed
 * from Spring's `BeanUtils.isSimpleProperty` and verified against the vendor
 * page. Two spellings of one fact is the R137 shape, and this copy had already
 ...
 * disagreed with the wrong spelling — R168 exactly: a wrong FQN agreeing only
...
class AllPayloadSimpleTypesTest {
    ...
    fun everyBuiltinSimpleTypeIsSpelledTheWayThePackSpellsIt() {
        ...
        assertTrue(
            ...
            "no framework declares simpleParameterTypes; this check would pass vacuously (R63)",
        )
